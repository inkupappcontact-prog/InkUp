  ...
  return (
    <div className="mb-6 group relative z-0">
      ...
      <div className="relative">
        <div className={`
          transform -skew-x-12 border-[3px] bg-black h-14 flex items-center
          transition-all duration-150 ease-out
          ${isFocused ? 'border-[#2563EB] shadow-[6px_6px_0px_0px_#2563EB]' : 'border-[#2563EB] shadow-[6px_6px_0px_0px_#2563EB]'}
          ${error ? 'border-[#FF0000] shadow-[6px_6px_0px_0px_#FF0000]' : ''}
        ...
        {error && (
          <div className="absolute -right-2 -bottom-5 bg-[#FF0000] border-2 border-black text-white px-3 py-0.5 text-[10px] font-black uppercase italic z-20 transform -skew-x-12 shadow-[4px_4px_0px_0px_#000]">
