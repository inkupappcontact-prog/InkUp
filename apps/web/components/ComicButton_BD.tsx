...
const ComicButton: React.FC<ComicButtonProps> = ({ 
  ...
  const variants = {
    ...
    // Secondary: Blue background, Black text
    secondary: "bg-[#2563EB] text-[#000000] border-2 border-black shadow-[6px_6px_0px_0px_#000000] hover:shadow-[3px_3px_0px_0px_#000000] hover:translate-x-[3px] hover:translate-y-[3px] active:shadow-none"
  };
