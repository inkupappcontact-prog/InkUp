...
import { X, FileText, ShieldCheck, Users } from 'lucide-react';
...
const LegalModal: React.FC<LegalModalProps> = ({ type, onClose }) => {
  // TODO: activer une logique de validation des CGU si besoin
          ...
          <div className="space-y-6 text-sm">
            <section>
              ...
              <p>
                ...
                plateforme InkUp, spécialisée dans la distribution de bandes dessinées numériques et physiques.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                L&apos;utilisation de la plateforme InkUp implique l&apos;acceptation pleine et entière des présentes
                CGU. En cas de non-acceptation, l&apos;utilisateur doit cesser d&apos;utiliser le service.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                L'inscription est gratuite et réservée aux personnes majeures disposant de la capacité juridique pour
                contracter. Chaque utilisateur s'engage à fournir des informations exactes et à maintenir ses
            ...
            <section>
              ...
              <p>
                Les utilisateurs s'engagent à respecter les droits d'auteur et la propriété intellectuelle. Tout contenu
                contrefaisant ou illégal sera immédiatement supprimé et pourra entraîner la résiliation du compte.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                InkUp s'efforce d'assurer la disponibilité du service mais ne peut garantir une continuité absolue. La
                responsabilité d'InkUp est limitée aux dommages directs prévus par la loi.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Tous les éléments de la plateforme (logos, textes, graphismes, structure) sont protégés par le droit
        ...
        return (
          <div className="space-y-6 text-sm">
            <section>
              <h3 className="font-bold text-lg mb-3">1. Objet</h3>
              <p>
                Les présentes Conditions Générales de Vente (CGV) régissent les ventes de bandes dessinées numériques et
                physiques proposées par InkUp.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Les bandes dessinées numériques sont disponibles en téléchargement immédiat. Les exemplaires physiques
                sont expédiés sous 48h en France métropolitaine.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Les prix sont indiqués en euros TTC et incluent tous les frais applicables. InkUp se réserve le droit de
            ...
            <section>
              ...
              <p>
                Le paiement est sécurisé via Stripe. Les cartes bancaires acceptées sont : Visa, Mastercard, American
                Express. Le paiement est débité lors de la validation de la commande.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Les livraisons sont effectuées par La Poste. Les délais de livraison sont de 2-5 jours ouvrés. En cas de
                perte, un nouvel exemplaire sera expédié sans frais supplémentaires.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Conformément au Code de la consommation, l'utilisateur dispose d'un délai de 14 jours pour exercer son
                droit de rétractation. Pour les contenus numériques, ce droit s'applique uniquement si le téléchargement
          ...
          <div className="space-y-6 text-sm">
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  <strong>Données d'identification :</strong> email, nom, pseudonyme
                </li>
                <li>
                  <strong>Données de connexion :</strong> historique des connexions, préférences
                </li>
                <li>
                  <strong>Données de transaction :</strong> achats, paiements, adresses de livraison
                </li>
                <li>
                  <strong>Données techniques :</strong> adresse IP, type de navigateur, données d'utilisation
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  <strong>Consentement :</strong> pour la création de votre compte et les communications marketing
                </li>
                <li>
                  <strong>Exécution contractuelle :</strong> pour la fourniture des services InkUp
                </li>
                <li>
                  <strong>Obligation légale :</strong> pour la facturation et la comptabilité
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  <strong>Compte actif :</strong> pendant toute la durée de notre relation contractuelle
                </li>
                <li>
                  <strong>Données comptables :</strong> 10 ans (obligation légale)
                </li>
                <li>
                  <strong>Demandes de suppression :</strong> 30 jours après suppression du compte
                </li>
                <li>
                  <strong>Cookies :</strong> 13 mois maximum pour les cookies analytiques
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  <strong>Supabase Inc.</strong> - Hébergement de base de données (États-Unis - Privacy Shield)
                </li>
                <li>
                  <strong>Stripe Inc.</strong> - Traitement des paiements (États-Unis - Privacy Shield)
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  <strong>Cookies essentiels :</strong> nécessaires au fonctionnement du site (pas de consentement
                  requis)
                </li>
                <li>
                  <strong>Cookies de mesure d'audience :</strong> Google Analytics anonymisé (consentement requis)
                </li>
                <li>
                  <strong>Cookies de paiement :</strong> Stripe (consentement requis lors du paiement)
                </li>
              </ul>
              <p className="mt-2">Vous pouvez gérer vos préférences cookies via notre bandeau cookies.</p>
            </section>

            <section>
              <h3 className="font-bold text-lg mb-3">7. Sécurité</h3>
              <p>InkUp met en œuvre des mesures de sécurité appropriées :</p>
              <ul className="list-disc list-inside mt-2 space-y-1">
            ...
            <section>
              ...
              <ul className="list-disc list-inside mt-2 space-y-1">
                <li>
                  <strong>Email :</strong> privacy@inkup.com
                </li>
                <li>
                  <strong>Adresse :</strong> 1 RUE du Bois Joly, 49120 Chemillé-en-Anjou
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                Cette politique peut être modifiée pour tenir compte des évolutions légales et techniques. Toute
                modification sera notifiée aux utilisateurs par email et publiée sur cette page.
              </p>
              <p className="mt-2">
          ...
          <div className="space-y-6 text-sm">
            <section>
              ...
              <div className="space-y-2">
                <p>
                  <strong>Nom :</strong> {LEGAL_INFO.entrepreneur}
                </p>
                <p>
                ...
                <p>
                  <strong>SIREN :</strong> {LEGAL_INFO.siren}
                </p>
                <p>
                ...
                <p>
                  <strong>Code APE :</strong> {LEGAL_INFO.code_ape}
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-2">
                ...
                <p>
                  <strong>Adresse :</strong> 620 Dory Street, San Francisco, CA 94107, USA
                </p>
                <p>
                  <strong>Téléphone :</strong> +1 (415) 555-0123
                </p>
                <p>
                  <strong>Email :</strong> support@supabase.io
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <p>
                Ce site utilise des cookies conformément au RGPD. Consultez notre politique de confidentialité pour plus
                d'informations.
              </p>
            </section>
          </div>
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white border-4 border-black rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto p-8 relative">
        ...
        <div className="flex justify-end gap-4">
          <ComicButton onClick={onClose} className="px-6 py-2">
            Fermer
          </ComicButton>
        </div>
      </div>
